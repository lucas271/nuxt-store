<template>
    <div class="bg-white ma-2 d-flex flex-column pa-2 d-flex rounded-lg">
        ...
        <header class="w-100 d-flex flex-column ga-2">
            <div class="d-flex justify-space-between align-center flex-wrap ga-1 text-subtitle-2">
        ...
        <div class="flex-grow-1 flex-shrink-1 w-100">
            <v-card-text class="pa-0 ma-1 overflow-auto bg-teal-darken-3 pa-2 rounded-lg" :style="{minHeight: '8vh', maxHeight: '15vh'}">
                {{message}}
            </v-card-text>
        </div>
    </div>
